...
/* harmony import */ var _modules_animateSymbols__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/animateSymbols */ "./src/assets/js/modules/animateSymbols.js");
/* harmony import */ var _modules_burger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/burger */ "./src/assets/js/modules/burger.js");
/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modal */ "./src/assets/js/modules/modal.js");
/* harmony import */ var _modules_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/forms */ "./src/assets/js/modules/forms.js");
/* harmony import */ var _modules_scrolling__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/scrolling */ "./src/assets/js/modules/scrolling.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_animateSymbols__WEBPACK_IMPORTED_MODULE_0__["default"])('.cost', '.flying-symbol');
  Object(_modules_animateSymbols__WEBPACK_IMPORTED_MODULE_0__["default"])('.intro', '.flying-symbol');
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_1__["default"])('.header__main-nav', '.menu-button');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])('.button', '.modal__overlay');
...
/***/ "./src/assets/js/modules/animateSymbols.js":
/*!*************************************************!*\
  !*** ./src/assets/js/modules/animateSymbols.js ***!
  \*************************************************/
...
var animateSymbols = function animateSymbols(parentSelector, symbolsSelector) {
  ...
  var showAymbols = function showAymbols() {
    symbolsElems.forEach(function (symbol) {
      var symbolName = symbol.className.match(/flying-symbol--.*/g),
          specialClass = "".concat(parentClassName, "__").concat(symbolName),
          commonClass = "".concat(parentClassName, "__flying-symbol");
      symbol.classList.add(commonClass, specialClass);
    });
    isShowed = true;
  };

  var isParentElemInView = function isParentElemInView() {
...
/* harmony default export */ __webpack_exports__["default"] = (animateSymbols);
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  burgerElem.addEventListener('click', function () {
    if (getComputedStyle(menuElem).visibility === 'hidden' && window.screen.availWidth < 992) {
      ...
      setTimeout(function () {
        return menuElem.style.visibility = 'hidden';
      }, 300);
    }
  });
};
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modal */ "./src/assets/js/modules/modal.js");
...
var forms = function forms() {
  ...
  form.addEventListener('submit', function (e) {
    ...
    postData('../../server.php', formData).then(function (res) {})["catch"](function (err) {})["finally"](function () {
      setTimeout(function () {
        Object(_modal__WEBPACK_IMPORTED_MODULE_9__["closeModal"])('.modal__overlay');
      }, 1500);
      clearInputs();
      setTimeout(function () {
...
var closeModal = function closeModal(modalSelector) {
  ...
  setTimeout(function () {
    return modalElem.style.visibility = 'hidden';
  }, 300);
  document.body.style.overflow = '';
};

var modal = function modal(triggerSelectror, modalSelector) {
  var modalElem = document.querySelector(modalSelector),
      contactFormElem = modalElem.querySelector('.contact-form'),
      modalCloseBtn = modalElem.querySelector('.close-button'),
      modalTrigger = [].concat(_toConsumableArray(document.querySelectorAll(triggerSelectror)), [document.querySelector('.call-button.call-button--mobile')]);
...
/***/ "./src/assets/js/modules/scrolling.js":
/*!********************************************!*\
  !*** ./src/assets/js/modules/scrolling.js ***!
  \********************************************/
/*! exports provided: default */
...
var scrolling = function scrolling() {
  ...
  function animate(_ref, widthTop, toBlock, elemHeight) {
  ...
  var quad = function quad(timeFraction) {
    return Math.pow(timeFraction, 3);
  };

  var linear = function linear(timeFraction) {
    return timeFraction;
  };

  var draw = function draw(progress, toBlock, widthTop, elemHeight) {
    var r = toBlock < 0 ? widthTop - -toBlock * progress / speed : widthTop + toBlock * progress / speed;
    window.scrollTo(0, r);
  };
...
var slider = function slider(_ref) {
  var sliderSelector = _ref.sliderSelector,
      nextButtonSelector = _ref.nextButtonSelector,
      prevButtonSelector = _ref.prevButtonSelector;
  ...
  var sliderWidth = step * slides.length * 2;
  var firstSlideIndex = 0,
      lastSlideIndex = slides.length * 2 - 1;

  var initSlider = function initSlider() {
    var slidesClones = Array.from(slides).map(function (slide) {
      return slide.cloneNode(true);
    });
    slidesClones.forEach(function (clone, i) {
    ...
    slides.forEach(function (slide) {
      return slide.style.width = step + 'px';
    });
    sliderWrapper.style.cssText = "\n            position: relative;\n            left: -".concat(step, "px;\n\n            width: ").concat(sliderWidth, "px;\n        ");
  };

  var cycleArr = function cycleArr(arr, direction) {
    var first = arr[0],
  ...
  initSlider();
  var sliderOffset = 0,
      itemsAndPositions = Array.from(slides).map(function (slide) {
    return {
      slide: slide,
      position: 0
    };
  ...
  var moveItems = function moveItems(direction) {
    switch (direction) {
      case 'right':
        var currentItemRight = itemsAndPositions[lastSlideIndex];
        currentItemRight.position -= sliderWidth;
        sliderOffset += step;
        currentItemRight.slide.style.transform = "translateX(".concat(currentItemRight.position, "px)");
        sliderWrapper.style.transform = "translateX(".concat(sliderOffset, "px)");
        itemsAndPositions = cycleArr(itemsAndPositions, direction);
        break;

      case 'left':
        var currentItemLeft = itemsAndPositions[firstSlideIndex];
        currentItemLeft.position += sliderWidth;
        sliderOffset -= step;
        currentItemLeft.slide.style.transform = "translateX(".concat(currentItemLeft.position, "px)");
        sliderWrapper.style.transform = "translateX(".concat(sliderOffset, "px)");
        itemsAndPositions = cycleArr(itemsAndPositions, direction);
        break;
    }
